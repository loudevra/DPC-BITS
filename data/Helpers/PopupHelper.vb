...
Public Class PopupHelper
    ...
    Public Shared Sub OpenPopupWithControl(sender As Object, control As UserControl, Optional verticalOffset As Double = 0, Optional horizontalOffset As Double = 0, Optional currentWindow As Window = Nothing)
