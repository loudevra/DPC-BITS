...
Namespace DPC.Views.Misc.CashAdvance
    Public Class CashAdvanceNewRequest
        ...
        Public Sub New()
            ...
            AddHandler AutoCompleteTextBox.TextChanged, AddressOf TxtToUpper_TextChanged
            AddHandler SupervisorName.TextChanged, AddressOf TxtToUpper_TextChanged
            AddHandler approverRemarks.TextChanged, AddressOf TxtToUpper_TextChanged
            AddHandler TxtRequestedBy.TextChanged, AddressOf TxtToUpper_TextChanged
        End Sub
