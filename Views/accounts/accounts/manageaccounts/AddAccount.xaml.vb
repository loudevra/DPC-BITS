...
Namespace DPC.Views.Accounts.Accounts.ManageAccounts
    Public Class AddAccount
        ...
        Public Sub New()
            ...
            LoadAccountTypes()
            ' Attach uppercase handler to textboxes
            AddHandler txtAccountNo.TextChanged, AddressOf TxtToUpper_TextChanged
            AddHandler txtName.TextChanged, AddressOf TxtToUpper_TextChanged
            AddHandler txtInitialBalance.TextChanged, AddressOf TxtToUpper_TextChanged
