...
Namespace DPC.Views.Accounts.Accounts.ManageAccounts
    Public Class AccountStatement
        ...
        Public Sub New()
            ...
            ' Attach uppercase handler for textboxes
            AddHandler TxtEmployee.TextChanged, AddressOf TxtToUpper_TextChanged
            AddHandler TxtDateTimePicker.TextChanged, AddressOf TxtToUpper_TextChanged
        End Sub
