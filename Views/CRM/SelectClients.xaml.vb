...
Namespace DPC.Views.CRM
    Public Class SelectClients
        ...
        Private selectedType As String = "Residential"
        ...
        Private Sub NavigateToCRMCorporationalTabStructured(sender As Object, e As RoutedEventArgs)
            ViewLoader.DynamicView.NavigateToView("newcorporationalclient", Me)
        End Sub

        Private Sub NavigateToNewResidentialClient(sender As Object, e As RoutedEventArgs)
            ViewLoader.DynamicView.NavigateToView("newresidentialclient", Me)
        End Sub

        Private Sub NavigateToWalkInNewOrder(sender As Object, e As RoutedEventArgs)
            ViewLoader.DynamicView.NavigateToView("walkinorder", Me)
        End Sub

        Private Sub ResidentialCard_Click(sender As Object, e As RoutedEventArgs)
            selectedType = "Residential"
            UpdateSelection()
        End Sub

        Private Sub CorporationalCard_Click(sender As Object, e As RoutedEventArgs)
            selectedType = "Corporational"
            UpdateSelection()
        End Sub
        ...
        Private Sub ContinueButton_Click(sender As Object, e As RoutedEventArgs)
            If selectedType = "Residential" Then
                NavigateToNewResidentialClient(sender, e)
            Else
                NavigateToCRMCorporationalTabStructured(sender, e)
            End If
        End Sub
    End Class
End Namespace
