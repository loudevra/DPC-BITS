...
Namespace DPC.Components.UI
    Public Class PopUpMenuMiscelleneous
        ...
        Private Sub NavigateToCreateNote(sender As Object, e As RoutedEventArgs)
            ' Implementation for navigating to Create Note

        End Sub

        Private Sub NavigateToManageNotes(sender As Object, e As RoutedEventArgs)
            ' Implementation for navigating to Manage Notes
